    ...
    public Exchange aggregate(Exchange oldExchange, Exchange newExchange) {
        try {
            ...
            KieServicesConfiguration conf =
                    KieServicesFactory.newRestConfiguration("http://rhpam-trial-kieserver-http-self-healing.apps.cluster-z59lg.z59lg.sandbox749.opentlc.com/services/rest/server", "adminUser", "RedHat");
...
//            DMNModel dmnModel = dmnRuntime.getModel(namespace, modelName);
                ...
                ServiceResponse<DMNResult> serverResp =
                        dmnClient.evaluateAll("EventAutomationDecision_1.0.0",
                                namespace,
                                modelName,
                                dmnContext);
